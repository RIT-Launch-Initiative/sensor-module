##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.18.0-B7] date: [Thu Dec 29 00:38:54 EST 2022] 
##########################################################################################################################
# ------------------------------------------------
...
CFLAGS = $(MCU) $(C_DEFS) $(C_INCLUDES) $(OPT) -Wall -fdata-sections -ffunction-sections -O0
ifeq ($(DEBUG), 1)
CFLAGS += -g -gdwarf-2
endif
...
LDFLAGS += -specs=nosys.specs # c++ breaks without this, but things like sbrk won't work for malloc
